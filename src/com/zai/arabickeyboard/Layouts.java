...
public final class Layouts {
    ...
    public static List<Row> latin(int lang, boolean numRow) {
        ...
        rows.add(row(k3));
        rows.add(arBottom(lang));
        return rows;
    }

    // ==================== الصف السفلي المشترك ====================

    private static Row arBottom(int lang) {
