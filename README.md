...
### حواف زجاجية مضيئة للشريطين — جديد 2.8
- 💡 **حد متدرج الإضاءة (Lit Edge)**: حافة الشريط العلوي والسفلي لم تعد خطاً ثابتاً — حد متدرج ساطع عند الأعلى يتلاشى نحو الأسفل كأن ضوءاً يسقط على الزجاج، وينحدر حدّ الشريط السفلي نحو البنفسجي عند الملامسة
- 🌟 **توهج خارجي ناعم (Glow Halo)**: ثلاث طبقات توهج متراكبة حول حواف الشريطين والكبسولة النشطة بعرض متزايد وشفافية متناقصة — إحساس طفو زجاجي حقيقي بلا حواف حادة
- 🔷 **انعكاس داخلي علوي (Inner Shine)**: خط ضوئي رفيع يلمع أسفل الحافة العلوية لكل شريط ثم يتلاشى — تفصيل زجاجي Premium
- ⬭ **نصف قطر موحد**: 30dp للشريطين مع كبسولة التبويب النشط بحافة بنفسجية متوهجة من نفس النظام
- 📐 **منطقة أمان شريط النظام**: القرص السفلي يرتفع تلقائياً فوق شريط التنقل/الإيماءات في النظام عبر WindowInsets على كل الشاشات

### واجهة زجاجية Premium (Glassmorphism) — جديد 2.7
- 🔮 **Glassmorphism حقيقي**: كل البطاقات أصبحت زجاجاً شبه شفاف بحدود مضيئة رقيقة فوق خلفية Aurora بنفسجية متوهجة، وعلى Android 12+ تُعالَج الخلفية بـ **Blur حقيقي** عبر RenderEffect
- ✨ **خلفية Aurora**: قاعدة كحلية داكنة مع هالات بنفسجية ناعمة تمنح الزجاج شفافية مرئية وتوهجاً محدوداً أنيقاً
- 💎 **الشريط العلوي**: بطاقة زجاجية بشعار متوهج (هالة شعاعية + حاوية متدرجة + أيقونة مرسومة) وشارة إصدار زجاجية
- 🧊 **شريط تنقّل سفلي زجاجي عائم**: قطعة زجاج عائمة بحد مضيء، والتبويب النشط داخل كبسولة متوهجة متدرجة
- 👆 **تفاعل حي**: Ripple عند الضغط + انكماش مرن للبطاقات والمفاتيح + انتقالات ناعمة (تلاشٍ + انزلاق) بين الشاشات
- 📊 **أرقام متوهجة**: أرقام الإحصاءات بتوهج بنفسجي ناعم وTypography أكبر وأوضح
- 🛡 **جميع الوظائف كما هي**: نفس الميزات والشاشات الـ ٥ والفحص الذكي — بدون حذف أو تعطيل أي شيء، ونفس توقيع التطبيق (تثبيت مباشر)

### شريط علوي وسفلي عصري + أيقونات مرسومة بدل الإيموجي — 2.6
- 🏔 **شريط علوي جديد**: بطاقة متدرجة بحواف دائرية ناعمة (٢٤dp) وحدّ فاتح رقيق، شعار لوحة مفاتيح مرسوم داخل مربع متدرج، وعنوان مع سطر وصفي وشارة الإصدار
- 🎛 **شريط تنقّل سفلي عائم**: قرص مستقل بهوامش وحواف دائرية كاملة (٢٦dp)، والتبويب النشط داخل قرص ملون بحدّ مميز — مظهر عصري معتمد في أرقى التطبيقات
- ✒ **مكتبة أيقونات Canvas (٢٥ أيقونة)**: كل الإيموجي استُبدلت بأيقونات هندسية مرسومة بالكامل — البطاقات، أقسام الإعدادات، دليل الاستخدام، نتائج الفحص (نجاح/تحذير/فشل)، التثبيت في الحافظة، وأيقونة الحذف
- 🧩 **شارات أيقونات موحدة**: كل أيقونة داخل مربع دائري الحواف بلمسة لون التمييز — مظهر متناسق على كل الأجهزة دون تأثر بخط إيموجي النظام
- 🛡 نفس توقيع v2.5 — التثبيت فوق النسخة السابقة مباشرة دون حذف

### إصلاح مظهر الحروف + تطبيق متعدد الشاشات — 2.5
...
|---------|--------------|
| v2.8 | **حواف زجاجية مضيئة للشريطين العلوي والسفلي**: حد متدرج الإضاءة (ساطع أعلى ← خافت أسفل) + توهج خارجي ناعم بثلاث طبقات + انعكاس داخلي + كبسولة تبويب نشط متوهجة + منطقة أمان شريط النظام |
| v2.7 | **واجهة Glassmorphism Premium**: بطاقات زجاجية شفافة بحدود مضيئة + خلفية Aurora بنفسجية + Blur حقيقي (Android 12+) + تفاعل حي وانتقالات ناعمة |
| v2.6 | **شريط علوي وسفلي عصري بحواف محسّنة** + **استبدال كل الإيموجي بأيقونات Canvas مرسومة** (٢٥ أيقونة) |
